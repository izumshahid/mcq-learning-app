...
const QuestionAnswer = ({ questionNumber = 1, questionObj = {} }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl mb-5">
      <div>
        {isCorrect ? (
          <p className="text-main_green_color animate-pulse text-xl">
        ...
        <div className="mt-4 ml-1">
          ...
          >
            <div
              className={`${
                isSelected == 0 ? "border-main_green_color" : "border-gray-300"
              } border-2 rounded-full w-5 sm:w-6 h-5 sm:h-6 flex justify-center items-center`}
            >
              <p
                className={`${
                  isSelected == 0 ? "text-main_green_color" : "text-[#1F1F1F]"
                } text-xs sm:text-sm`}
              >
                A
              </p>
          ...
          >
            <div
              className={`${
                isSelected == 1 ? "border-main_green_color" : "border-gray-300"
              } border-2 rounded-full w-5 sm:w-6 h-5 sm:h-6 flex justify-center items-center`}
            >
              <p
                className={`${
                  isSelected == 1 ? "text-main_green_color" : "text-[#1F1F1F]"
                } text-xs sm:text-sm`}
              >
                B
              </p>
          ...
          >
            <div
              className={`${
                isSelected == 2 ? "border-main_green_color" : "border-gray-300"
              } border-2 rounded-full w-5 sm:w-6 h-5 sm:h-6 flex justify-center items-center`}
            >
              <p
                className={`${
                  isSelected == 2 ? "text-main_green_color" : "text-[#1F1F1F]"
                } text-xs sm:text-sm`}
              >
                C
              </p>
          ...
          >
            <div
              className={`${
                isSelected == 3 ? "border-main_green_color" : "border-gray-300"
              } border-2 rounded-full w-5 sm:w-6 h-5 sm:h-6 flex justify-center items-center`}
            >
              <p
                className={`${
                  isSelected == 3 ? "text-main_green_color" : "text-[#1F1F1F]"
                } text-xs sm:text-sm`}
              >
                D
              </p>
